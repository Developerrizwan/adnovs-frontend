              ...
              <Card>
                ...
                <CardBody>
                  <div id="usa-vectormap" style={{ height: "350px" }}>
                    <Vector value="us_aea" width="724" color="#3d78e3" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="canada-vectormap" style={{ height: "350px" }}>
                    <Vector value="ca_lcc" width="500" color="#29badb" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="russia-vectormap">
                    <Vector value="ru_mill" width="500" color="#67b173" />
                  </div>
                </CardBody>
              </Card>
            </Col>
              ...
              <Card>
                ...
                <CardBody>
                  <div id="spain-vectormap">
                    <Vector value="es_mill" width="500" color="#5b71b9" />
                  </div>
                </CardBody>
              </Card>
            </Col>
