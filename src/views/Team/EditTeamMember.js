            ...
            <div className="card-body">
              <Formik
                initialValues={{
                  ...
                  email_id: props.selectedTeam?.email_id,
                  designation: props.selectedTeam?.designation,
                  phone_number: props.selectedTeam?.phone_number,
                  project_id: props.selectedTeam?.selectedProject,
                }}
                ...
                onSubmit={(values, { resetForm }) => {
                  const url = `/api/teams/${props.selectedTeam?.id}`;
                  let object = {
                    name: values["name"],
                      ...
                      <Colxx lg="4">
                        <div className="form-group mb-3">
                          ...
                          <Select
                            ...
                            placeholder={"Select"}
                            defaultInputValue={
                              props.selectedTeam?.selectedProject
                            }
                            // value={props.selectedTeam?.selectedProject}
