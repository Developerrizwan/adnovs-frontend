      ...
      <div className="card reportdownproject mb-5">
        ...
        <div className="row p-2">
          <div className="col-lg-6 col-xs-12">
            <table>
              <tr>
                <td className="border-0 fw">Paid To:</td>
                <td className="border-0"></td>
              </tr>
              <tr>
              ...
              <tr>
                <td className="border-0 fw">Paid From:</td>
                <td className="border-0"></td>
              </tr>
              <tr>
              ...
              <tr>
                <td className="border-0 fw">Ref No. / Date:</td>
                <td className="border-0"></td>
              </tr>
              <tr>
                <td className="border-0 fw">Remarks:</td>
                <td className="border-0"></td>
              </tr>
            </table>
          </div>
          <div className="col-lg-6 col-xs-12">
            <table>
              <tr>
                <td className="border-0 fw">Payment No:</td>
                <td className="border-0"></td>
              </tr>
              <tr>
        ...
        <div className="p-2" style={{ overflowX: "auto" }}>
          <table className="htmlTable mt-2 w-100">
            <tr>
              ...
              <th className="text-center">Shipment / Job No</th>
              <th className="text-center">Local Amount</th>
            </tr>
            <tr>
        ...
        <div className="p-2" style={{ overflowX: "auto" }}>
          <table className="htmlTable mt-2 w-100">
            ...
            <tr>
              <td className="text-end">8349</td>
              <td className="text-end">08/05/2023</td>
              <td className="text-end">ADN/7326487</td>
              <td className="text-end">bahsjskd</td>
              <td className="text-end">DR</td>
