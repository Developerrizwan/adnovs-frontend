...
const AccountPayableStatement = (props) => {
  ...
  const getInvoices = (id) => {
    ...
    apiAuth
      ...
      .then((response) => {
        ...
        results = results.filter((dd) => dd.invoice_type === "Purchase");
        setInvoices(results);
        setLoading(false);
      })
      .catch((error) => {
          ...
          <div className="row">
            ...
            >
              <h3>
                ...
                <Translate text={"TAccounts Payable Statement"} />
              </h3>
            </div>
...
export default AccountPayableStatement;
